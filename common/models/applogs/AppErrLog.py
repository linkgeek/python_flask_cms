...
class AppErrLog(db.Model):
    ...
    request_uri = db.Column(db.String(255, 'utf8mb4_general_ci'), nullable=False, server_default=db.FetchedValue(),
                            info='请求uri')
    referer = db.Column(db.String(500, 'utf8mb4_general_ci'), nullable=False, server_default=db.FetchedValue(),
                        info='来源url')
    content = db.Column(db.String(3000, 'utf8mb4_general_ci'), nullable=False, server_default=db.FetchedValue(),
                        info='日志内容')
